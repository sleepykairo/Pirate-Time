...
execute as @s[scores={storm=2,southHemisphere=1}] run title @a actionbar ["",{"text":"Your skin is burning off","color":"#FF8000"}]
execute as @s[scores={storm=3,southHemisphere=1}] run title @a actionbar ["",{"text":"Your entire body is burning","color":"#FF0000"}]

execute as @s[scores={storm=1,southHemisphere=0}] run title @a actionbar ["",{"text":"You are getting colder","color":"#00FFFF"}]
execute as @s[scores={storm=2,southHemisphere=0}] run title @a actionbar ["",{"text":"Your skin is freezing off","color":"#0080FF"}]
execute as @s[scores={storm=3,southHemisphere=0}] run title @a actionbar ["",{"text":"Your entire body is freezing","color":"#0000FF"}]
