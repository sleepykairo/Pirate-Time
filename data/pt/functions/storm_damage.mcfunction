...
execute as @s[scores={southHemisphere=1}] run playsound minecraft:entity.player.hurt_on_fire master @s ~ ~ ~ 1 1
execute as @s[scores={southHemisphere=1}] run playsound minecraft:entity.generic.extinguish_fire master @s ~ ~ ~ 1 1
