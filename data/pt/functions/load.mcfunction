...
scoreboard objectives add gc dummy

scoreboard objectives add alive dummy
scoreboard objectives add num dummy

scoreboard objectives add storm dummy
scoreboard objectives add southHemisphere dummy
scoreboard objectives add lightningDelay dummy
scoreboard objectives add weatherDelay dummy
scoreboard objectives add stormDamageDelay dummy

scoreboard objectives add bowShot dummy
...
scoreboard objectives add newVelX dummy
scoreboard objectives add newVelY dummy
scoreboard objectives add newVelZ dummy
